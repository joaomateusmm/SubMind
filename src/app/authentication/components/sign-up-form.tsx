...
const SignUpForm = ({ switchToSignIn }: { switchToSignIn?: () => void }) => {
  ...
  const [isDiscordLoading, setIsDiscordLoading] = useState(false); // Novo estado
          ...
          <CardFooter className="flex flex-col gap-4 px-0">
            ...
            <div className="grid w-full grid-cols-2 gap-3">
              ...
              <Button
                ...
                disabled={isLoading || isGoogleLoading || isDiscordLoading}
                className="group h-12 w-full border border-white/10 bg-white/5 text-neutral-400 transition-all duration-300 hover:border-white hover:bg-white hover:text-black"
              >
                {isGoogleLoading ? (
              ...
              <Button
                ...
                disabled={isLoading || isGoogleLoading || isDiscordLoading}
                className="group h-12 w-full border border-white/10 bg-white/5 text-neutral-400 transition-all duration-300 hover:border-[#5865F2] hover:bg-[#5865F2] hover:text-white"
              >
                {isDiscordLoading ? (
                  <Loader2 className="h-4 w-4 animate-spin" />
                ) : (
